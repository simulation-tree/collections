...
namespace Collections.Generic
{
    public unsafe static class ArrayExtensions
    {
        ...
        /// </summary>
        public static int IndexOf<T>(this Array<T> array, T value) where T : unmanaged, IEquatable<T>
        {
        ...
        /// </summary>
        public static int LastIndexOf<T>(this Array<T> array, T value) where T : unmanaged, IEquatable<T>
        {
        ...
        /// </summary>
        public static bool TryIndexOf<T>(this Array<T> array, T value, out int index) where T : unmanaged, IEquatable<T>
        {
        ...
        /// </summary>
        public static bool TryLastIndexOf<T>(this Array<T> array, T value, out int index) where T : unmanaged, IEquatable<T>
        {
